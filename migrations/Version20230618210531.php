 ...
 */
final class Version20230618210531 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_partners (id INT AUTO_INCREMENT NOT NULL, project_id INT DEFAULT NULL, partner_id INT DEFAULT NULL, INDEX IDX_D2A5DABF166D1F9C (project_id), INDEX IDX_D2A5DABF9393F8FE (partner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
